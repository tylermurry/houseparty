...
public static class TurnBasedGameExchanges
{
    ...
    public sealed record EndTurnRequest(string GameId, string PlayerId, string StatePayload);
    public sealed record EndTurnResponse(bool TurnEnded, string? StatePayload = null, string? ErrorMessage = null);
