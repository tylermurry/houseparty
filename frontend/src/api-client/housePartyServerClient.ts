...
/**
 * Instantiates a new {@link HousePartyServerClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createHousePartyServerClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<HousePartyServerClient>(requestAdapter, pathParameters, HousePartyServerClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface HousePartyServerClient extends BaseRequestBuilder<HousePartyServerClient> {
    /**
     * The api property
     */
 ...
 */
export const HousePartyServerClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const HousePartyServerClientNavigationMetadata: Record<Exclude<keyof HousePartyServerClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
